# Pipery ArgoCD CD Component

Reusable GitLab CI/CD component for complete ArgoCD deployment pipeline with structured logging.

## Overview

This component provides a complete CD (deployment) pipeline using ArgoCD:
- Image/artifact pull
...
```yaml
include:
  - component: $CI_SERVER_FQDN/pipery-dev/pipery-argocd-cd/catalog-resources/pipery-argocd-cd@main
